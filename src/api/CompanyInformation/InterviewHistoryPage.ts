 ...
 */
export const getUserInterviewList = async (userId: number) => {
  try {
 ...
 * [참조 테이블]: company_user_qnas
 */
export const deleteInterviewRecord = async (id: number) => {
  try {
 ...
 * [참조 테이블]: company_user_qnas
 */
export const getInterviewCount = async (userId: number) => {
  try {
