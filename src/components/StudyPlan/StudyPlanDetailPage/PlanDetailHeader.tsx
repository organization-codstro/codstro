...
import { PlanDetailHeaderProps } from "../../../types/pages/StudyPlan/StudyPlanDetailPage/PlanDetailHeader";

//기본 이미지
import StudyPlanBasicImg from "../../../assets/images/StudyPlan/StudyPlanBasicImg.png";
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => navigate(`/study-plan/${planId}/edit`)}
