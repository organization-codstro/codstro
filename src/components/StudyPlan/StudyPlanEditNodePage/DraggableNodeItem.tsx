...
import { DraggableNodeItemProps } from "../../../types/pages/StudyPlan/StudyPlanEditNodePage/DraggableNodeItem";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={(e) =>
            node.study_plan_node_id && onDeleteClick(e, node.study_plan_node_id)
          }
