...
import { PendingNoteBannerProps } from "../../../../../types/pages/Concepts/NoteUpdatePage/ChatPanel/PendingNoteBanner/PendingNoteBanner";

export default function PendingNoteBanner({
  currentMarkdown,
  pendingNote,
  onAccept,
  onReject,
}: PendingNoteBannerProps) {
  return (
    <div className="flex-shrink-0 bg-white border-b border-zinc-200">
      ...
      <div className="px-4 py-3">
        <DiffView original={currentMarkdown} updated={pendingNote} />
      </div>
    </div>
  );
}
