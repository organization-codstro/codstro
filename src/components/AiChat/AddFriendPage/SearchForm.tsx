...
import { SearchFormProps } from "../../../types/pages/AiChat/AddFriendPage/SearchForm";

export const SearchForm = ({ form, setForm, onSearch }: SearchFormProps) => {
  return (
    <div className="p-6 mb-8 bg-white border border-gray-200 shadow-sm rounded-2xl">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-1 md:col-span-2">
          <label htmlFor="topics" className="text-sm font-medium text-gray-600">
            Topics / Interests
          </label>
          <input
            id="topics"
