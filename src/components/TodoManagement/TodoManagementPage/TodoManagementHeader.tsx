...
import { TodoManagementHeaderProps } from "../../../types/pages/TodoManagement/TodoManagementPage/TodoManagementHeader";

export const TodoManagementHeader: React.FC<TodoManagementHeaderProps> = ({
  onOpenModal,
}) => (
