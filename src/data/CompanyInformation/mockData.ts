import { Company, CompanyMatch, CompanyQna, CompanyUserQna, CompanyUserMatchRecord } from '../../types/CompanyInformation/company';
...
export const mockCompanies: Company[] = [
  {
    ...
    companie_description: 'Leading provider of cloud-based solutions for modern web applications.',
  ...
  },
  {
    ...
    companie_description: 'Specializing in big data analytics and machine learning solutions.',
  ...
  },
  {
    ...
    companie_description: 'Creating beautiful and functional mobile applications for iOS and Android.',
  ...
  },
  {
    ...
    companie_description: 'Providing enterprise-grade DevOps tools and infrastructure solutions.',
  ...
  },
  {
    ...
    companie_description: 'Expert team focused on creating stunning user interfaces and experiences.',
...
export const mockQnas: Record<number, CompanyQna[]> = {
  1: [
    {
      company_qna_id: '1-1',
      company_qna_question: 'Describe a challenging technical problem you solved and how you approached it.',
      company_qna_answer: null,
      company_qna_question_reason: 'Tests problem-solving ability and technical depth',
      company_qna_created_date: '2024-12-23',
      company_id: 1,
    },
    {
      company_qna_id: '1-2',
      company_qna_question: 'How do you ensure code quality and maintainability in your projects?',
      company_qna_answer: null,
      company_qna_question_reason: 'Evaluates best practices and code standards awareness',
      company_qna_created_date: '2024-12-23',
      company_id: 1,
    },
    {
      company_qna_id: '1-3',
      company_qna_question: 'Tell me about a time you worked effectively in a team to deliver a project.',
      company_qna_answer: null,
      company_qna_question_reason: 'Assesses collaboration and communication skills',
      company_qna_created_date: '2024-12-23',
      company_id: 1,
    },
  ],
  2: [
    {
      company_qna_id: '2-1',
      company_qna_question: 'Explain how you would approach analyzing a large dataset to extract meaningful insights.',
      company_qna_answer: null,
      company_qna_question_reason: 'Tests analytical thinking and data methodology',
      company_qna_created_date: '2024-12-23',
      company_id: 2,
    },
    {
      company_qna_id: '2-2',
      company_qna_question: 'What is your experience with machine learning algorithms and when would you use them?',
      company_qna_answer: null,
      company_qna_question_reason: 'Evaluates ML knowledge and practical application',
      company_qna_created_date: '2024-12-23',
      company_id: 2,
    },
    {
      company_qna_id: '2-3',
      company_qna_question: 'How do you stay updated with the latest trends in data science and AI?',
      company_qna_answer: null,
      company_qna_question_reason: 'Assesses continuous learning and industry awareness',
      company_qna_created_date: '2024-12-23',
      company_id: 2,
    },
  ],
  3: [
    {
      company_qna_id: '3-1',
      company_qna_question: 'What considerations do you take into account when designing a mobile user interface?',
      company_qna_answer: null,
    ...
    {
      company_qna_id: '3-2',
      company_qna_question: 'Describe your experience with mobile app performance optimization.',
      company_qna_answer: null,
      company_qna_question_reason: 'Evaluates technical mobile development skills',
      company_qna_created_date: '2024-12-23',
      company_id: 3,
    },
    {
      company_qna_id: '3-3',
      company_qna_question: 'How do you handle different screen sizes and device capabilities in your apps?',
      company_qna_answer: null,
      company_qna_question_reason: 'Assesses responsive design and platform awareness',
      company_qna_created_date: '2024-12-23',
      company_id: 3,
    },
  ],
  4: [
    {
      company_qna_id: '4-1',
      company_qna_question: 'Explain your understanding of CI/CD and how you would implement it.',
      company_qna_answer: null,
    ...
    {
      company_qna_id: '4-2',
      company_qna_question: 'How would you approach migrating a monolithic application to microservices?',
      company_qna_answer: null,
      company_qna_question_reason: 'Evaluates system architecture understanding',
      company_qna_created_date: '2024-12-23',
      company_id: 4,
    },
    {
      company_qna_id: '4-3',
      company_qna_question: 'What strategies do you use to ensure high availability and disaster recovery?',
      company_qna_answer: null,
      company_qna_question_reason: 'Assesses infrastructure reliability knowledge',
      company_qna_created_date: '2024-12-23',
      company_id: 4,
    },
  ],
  5: [
    {
      company_qna_id: '5-1',
      company_qna_question: 'Walk me through your process for turning a design mockup into production code.',
      company_qna_answer: null,
      company_qna_question_reason: 'Tests design-to-code workflow understanding',
      company_qna_created_date: '2024-12-23',
      company_id: 5,
    },
    {
      company_qna_id: '5-2',
      company_qna_question: 'How do you balance aesthetic design with performance and accessibility?',
      company_qna_answer: null,
    ...
    {
      company_qna_id: '5-3',
      company_qna_question: 'Describe a time when you received critical feedback on your design and how you handled it.',
      company_qna_answer: null,
...
export const mockUserInterviews: CompanyUserQna[] = [
  {
    id: 1,
    user_id: 1,
    company_user_qna_answer: 'I solved a performance bottleneck in our React application by implementing lazy loading and code splitting, which reduced the initial bundle size by 40%.',
    company_qna_question: 'Describe a challenging technical problem you solved and how you approached it.',
    company_user_qna_evaluation: '매우 구체적이고 실무 경험이 드러나는 답변입니다. STAR 기법을 잘 활용했습니다.',
  ...
  },
  {
    id: 2,
    user_id: 1,
    company_user_qna_answer: 'I ensure code quality through code reviews, unit tests, and following SOLID principles. I also use ESLint and TypeScript for type safety.',
    company_qna_question: 'How do you ensure code quality and maintainability in your projects?',
    company_user_qna_evaluation: '좋은 답변입니다. 더 구체적인 프로젝트 예시를 추가하면 더 좋을 것 같습니다.',
    company_user_qna_create_date: '2024-12-20',
    company_qna_id: 2,
  },
  {
    id: 3,
    user_id: 1,
    company_user_qna_answer: 'In my previous project, I worked with a team to deliver a mobile app. I communicated regularly with the backend team and participated in daily standups.',
    company_qna_question: 'Tell me about a time you worked effectively in a team to deliver a project.',
  ...
  },
  {
    id: 4,
    user_id: 1,
    company_user_qna_answer: 'I would start by understanding the data structure and creating visualizations to identify patterns and outliers.',
    company_qna_question: 'Explain how you would approach analyzing a large dataset to extract meaningful insights.',
  ...
  },
  {
    id: 5,
    user_id: 1,
    company_user_qna_answer: 'I have experience with basic machine learning concepts and have used scikit-learn for classification tasks in university projects.',
    company_qna_question: 'What is your experience with machine learning algorithms and when would you use them?',
    company_user_qna_evaluation: '기초 지식은 있으나 더 깊이 있는 경험이 필요합니다.',
