...
export const existingNodes: StudyPlanNode[] = [
  {
    ...
    study_plan_node_description: "Learn semantic HTML and modern CSS",
    study_plan_node_start_date: "2025-01-01",
    study_plan_node_end_date: "2025-01-07",
  ...
  },
  {
    ...
    study_plan_node_description: "Closures, async/await, prototype",
    study_plan_node_start_date: "2025-01-08",
    study_plan_node_end_date: "2025-01-20",
