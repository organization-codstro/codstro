...
export const majors: Major[] = [
  {
    ...
    detailedDescription:
      "Frontend development focuses on everything users see and interact with in web applications. You will create beautiful, responsive interfaces that provide seamless user experiences across all devices. This field combines technical skills with creative design thinking.",
    keySkills: [
  ...
  },
  {
    ...
    detailedDescription:
      "Backend development powers everything behind the scenes. You will build robust servers, design efficient databases, and create APIs that enable applications to function. This role focuses on logic, security, and performance.",
    keySkills: [
  ...
  },
  {
    ...
    detailedDescription:
      "Mobile development brings applications to billions of smartphone users worldwide. You will create native or cross-platform apps that provide rich experiences on mobile devices. This field requires understanding mobile-specific challenges like battery life, touch interfaces, and varied screen sizes.",
    keySkills: [
  ...
  },
  {
    ...
    detailedDescription:
      "Data Science combines programming, statistics, and domain knowledge to extract insights from data. You will build machine learning models, analyze trends, and help organizations make data-driven decisions. This rapidly growing field is transforming every industry.",
    keySkills: [
