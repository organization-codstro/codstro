...
export const fortunes: Fortune[] = [
  ...
  },
  {
    ...
    description:
      "A 200 status means everything is working perfectly. Your request was successful, and the response is exactly what you expected. Today is your day - your code compiles, tests pass, and everything just clicks into place. It's the kind of day where you can tackle challenging problems with confidence.",
    categoryMessage:
      "Development: Perfect day for implementing new features or refactoring complex code. Your logic is sharp!\nMeetings: Your ideas will be well-received. Speak up and share your insights with confidence.\nLifestyle: Everything flows naturally today. Enjoy the momentum and celebrate small wins!",
  },
  {
    id: "3",
    code: 404,
    ...
    description:
      "A 404 means the requested resource wasn't found. But getting lost isn't always bad - sometimes it leads you to discover something unexpected. Today might feel a bit disorienting, but stay curious. The path you're looking for might not exist, but perhaps you'll find an even better route.",
    categoryMessage:
      "Development: If you can't find the solution, try a different approach. Sometimes the best answers come from unexpected places.\nMeetings: If the discussion goes off-track, don't worry. New perspectives often emerge from unexpected conversations.\nLifestyle: Embrace the uncertainty. Getting lost in a new coffee shop or taking a different route home might brighten your day.",
  },
];
