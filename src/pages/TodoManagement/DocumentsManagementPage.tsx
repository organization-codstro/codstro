...
// API 서비스 및 인증 서비스
import { DocumentsManagementService } from "../../api/TodoManagement/DocumentsManagementPage";
import { LoginService } from "../../api/Auth/LoginPage";

// 기존 컴포넌트 및 설정
import { CreateCustomFieldModal } from "../../components/TodoManagement/DocumentsManagementPage/Modal/CreateCustomFieldModal";
import { CreateDocumentModal } from "../../components/TodoManagement/DocumentsManagementPage/Modal/CreateDocumentModal";
import { EditDocumentModal } from "../../components/TodoManagement/DocumentsManagementPage/Modal/EditDocumentModal";
import { ManagementHeader } from "../../components/TodoManagement/DocumentsManagementPage/ManagementHeader";
import { DocumentFilterBar } from "../../components/TodoManagement/DocumentsManagementPage/DocumentFilterBar";
import { FieldItem } from "../../components/TodoManagement/DocumentsManagementPage/FieldItem";
import { ManagementSidebar } from "../../components/TodoManagement/DocumentsManagementPage/ManagementSidebar";
import {
  CreateFieldParams,
  CreatePinParams,
...
export default function DocumentsManagementPage() {
  ...
  }, [todoData, selectedGroupType, searchQuery]);

  const stats = useMemo(() => {
    const totalFields = todoData.reduce(
      (acc, g) => acc + (g.fields?.length || 0),
      0,
    );
    const totalPins = todoData.reduce(
      (acc, g) =>
        acc +
        (g.fields?.reduce(
