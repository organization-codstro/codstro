...
// UI 컴포넌트
import { TodoDetailHeader } from "../../components/TodoManagement/TodoManagementDetailPage/TodoDetailHeader";
import { TodoStatusBadge } from "../../components/TodoManagement/TodoManagementDetailPage/TodoStatusBadge";
import { TodoInfoSection } from "../../components/TodoManagement/TodoManagementDetailPage/TodoInfoSection";
import { TodoDetail } from "../../types/pages/TodoManagement/TodoManagementDetailPage/TodoManagementDetailPage";
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-4xl mx-auto space-y-6">
        <TodoDetailHeader
          onBack={() => navigate("/todo-management")}
          onEdit={() => navigate(`/todo-management/todo/${todo.todo_id}/edit`)}
        />
