...
export default function CompanyMatch() {
  ...
  if (!company || !match) {
    return <div className="p-8">Data not found</div>;
  }
          ...
          >
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                {company.company_name}와의 매칭 분석 결과
              </p>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <div className="prose-sm prose max-w-none">
                <ReactMarkdown>
                  {match.company_user_matche_reason}
                </ReactMarkdown>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-gray-200">
              ...
              <div className="prose-sm prose max-w-none">
                <ReactMarkdown>
                  {match.company_user_matche_suggestions}
                </ReactMarkdown>
              </div>
            </div>
            ...
            <div className="p-4 mt-8 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <p className="mt-2 text-xs text-gray-500">
                이 분석은 AI가 현재 유저 정보와 회사 정보를 종합적으로 비교하여
                생성한 결과입니다.
              </p>
            </div>
          </div>
