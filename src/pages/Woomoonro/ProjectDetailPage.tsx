...
import ProjectDetailHeader from "../../components/Woomoonro/ProjectDetailPage/ProjectDetailHeader";
import ProjectInfoGrid from "../../components/Woomoonro/ProjectDetailPage/ProjectInfoGrid";
import ProjectStatusCard from "../../components/Woomoonro/ProjectDetailPage/ProjectStatusCard";
...
const ProjectDetailPage: React.FC = () => {
  ...
  const onUpdateStatus = (status: UserProject["status"]) => {
