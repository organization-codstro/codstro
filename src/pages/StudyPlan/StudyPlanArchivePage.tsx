...
import { StudyPlanArchiveService } from "../../api/StudyPlan/StudyPlanArchivePage";
import { LoginService } from "../../api/Auth/LoginPage";
import { ArchiveStudyPlanCard } from "../../components/StudyPlan/StudyPlanArchivePage/ArchiveStudyPlanCard";
import { toast } from "react-toastify";
import { PlanStatsResult, StudyPlan } from "../../types/common/StudyPlan";
              ...
              {archivedPlans.map((plan) => {
                ...
                return (
                  <ArchiveStudyPlanCard
                    ...
                    onPlanClick={(id) => navigate(`/study-plan/plan/${id}`)}
