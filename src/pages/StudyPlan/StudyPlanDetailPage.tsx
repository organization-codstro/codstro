...
import { StudyPlanDetailService } from "../../api/StudyPlan/StudyPlanDetailPage";
import { BackButton } from "../../components/StudyPlan/StudyPlanDetailPage/BackButton";
import { PlanDetailHeader } from "../../components/StudyPlan/StudyPlanDetailPage/PlanDetailHeader";
import { MyNodeList } from "../../components/StudyPlan/StudyPlanDetailPage/MyNodeList/MyNodeList";
import { StudyPlanWithNodes } from "../../types/common/StudyPlan";
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-6xl mx-auto space-y-6">
        <BackButton label="Back to Archive" to="/study-plan" />
