...
import { PlanRegistrationService } from "../../api/StudyPlan/StudyPlanCreatePage";

import { toast } from "react-toastify";
import { useState } from "react";
import { LoginService } from "../../api/Auth/LoginPage";
import { StudyPlanFormFormData } from "../../types/pages/StudyPlan/StudyPlanForm";
...
export default function StudyPlanCreatePage() {
  ...
  const handleSave = async (data: StudyPlanFormFormData, imageFile?: File) => {
    try {
      ...
      navigate(`/study-plan/create/node/${newPlanId}`);
    } catch (error) {
